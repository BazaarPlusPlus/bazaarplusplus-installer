...
const zh = {
  ...
  branchSwitchHeading: 'Steam 分支',
  branchTargetOnline: 'Online 正式服',
  branchTargetPtr: 'PTR 测试服',
  branchSwitchOnlineDescription: '切回公开正式服',
  branchSwitchPtrDescription: '切到测试分支',
  branchSwitchCancel: '取消',
  branchSwitchCanceling: '取消中',
  branchSwitchCancelLocked: 'Steam 已开始写入游戏目录，请等待本次切换完成。',
  branchSwitchDone: 'Steam 分支切换完成',
  branchSwitchCanceled: 'Steam 分支切换已取消',
  branchSwitchPtrAuthRequired:
    'Steam 账号尚未解锁 PTR。请先在 Steam 的 The Bazaar 属性中输入一次 PTR 访问代码，完成授权后再重试。',
  branchSwitchPhaseIdle: '空闲',
  branchSwitchPhasePreCheck: '检查授权',
  branchSwitchPhaseQuitSteam: '关闭 Steam',
  branchSwitchPhaseEditAcf: '写入分支',
  branchSwitchPhaseDownloading: '下载分支',
  branchSwitchPhaseRepairing: '修复插件',
  branchSwitchPhaseRestoring: '恢复分支',
  branchSwitchPhaseCanceled: '已取消',
  branchSwitchPhaseReady: '已完成',
  branchSwitchPhaseError: '失败',
...
const en: Record<MessageKey, string> = {
  ...
  branchSwitchHeading: 'Steam Branch',
  branchTargetOnline: 'Online',
  branchTargetPtr: 'PTR',
  branchSwitchOnlineDescription: 'Return to the live branch',
  branchSwitchPtrDescription: 'Switch to the test branch',
  branchSwitchCancel: 'Cancel',
  branchSwitchCanceling: 'Canceling',
  branchSwitchCancelLocked:
    'Steam has started writing files into the game directory. Wait for this switch to finish.',
  branchSwitchDone: 'Steam branch switch complete',
  branchSwitchCanceled: 'Steam branch switch canceled',
  branchSwitchPtrAuthRequired:
    'This Steam account is not authorized for PTR yet. Enter the PTR access code once in Steam properties for The Bazaar, then retry here.',
  branchSwitchPhaseIdle: 'Idle',
  branchSwitchPhasePreCheck: 'Checking auth',
  branchSwitchPhaseQuitSteam: 'Closing Steam',
  branchSwitchPhaseEditAcf: 'Writing branch',
  branchSwitchPhaseDownloading: 'Downloading',
  branchSwitchPhaseRepairing: 'Repairing mod',
  branchSwitchPhaseRestoring: 'Restoring branch',
  branchSwitchPhaseCanceled: 'Canceled',
  branchSwitchPhaseReady: 'Ready',
  branchSwitchPhaseError: 'Failed',

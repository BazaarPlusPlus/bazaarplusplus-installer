...
import type { InstallPrimaryAction } from './installPageState';
          ...
          <div className="flex flex-col gap-5 flex-1">
            ...
            <ul className="flex flex-col gap-2">
              <InstallFactItem
                ...
                value={
                  state.mod_state.installed ? t('installed') : t('notInstalled')
                }
              />
            </ul>
            ...
            {page.message && (
              <p
                role="status"
                aria-live="polite"
                className="m-0 text-xs selectable text-[#6dd9a0]"
              >
                {page.message}
              </p>
            )}
...
function PrimaryActionButton({
  ...
  if (primaryAction.mode === 'choose-directory') {
    return (
      <button
        type="button"
        disabled={primaryAction.disabled}

...
- The main window is fixed at 1020 x 680 on macOS and overridden to 972 x 612 on Windows in `src-tauri/tauri.conf.json:13-25` and `src-tauri/tauri.windows.conf.json:3-20`.

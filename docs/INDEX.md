...
UI copy and locale citation refresh: `2026-08-08` on `c11d9039543f75ed93e6fc4e4f0fb73b6600bb2f` — `CONTEXT.md` plus the architecture, frontend, History/Stream, Updater/Release, and verification topics were checked against the pruned message catalog, the plural-token and host-language locale resolution, the unified stream-service/overlay vocabulary, the platform-selected recovery copy, the localized calibration page, and the CJK label typography rules.

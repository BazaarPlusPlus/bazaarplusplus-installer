...
Native replay-recorder release identity refresh: `2026-08-03` on `a4b4900c135fac5b737b7cfbf6c62972e54d09b9` — the updater-release and verification truth topics were checked against the pinned ad-hoc helper input, official Team ID gate, helper-specific notarization/stapling, and unchanged Windows FFmpeg contract.
...
| `docs/truth/updater-release.md` | updater-release | truth | `a4b4900c135fac5b737b7cfbf6c62972e54d09b9` |
| `docs/truth/verification.md` | verification | truth | `a4b4900c135fac5b737b7cfbf6c62972e54d09b9` |
...
| `docs/adr/011-native-replay-recorder-signing.md` | native-replay-recorder-signing | decision | n/a |
